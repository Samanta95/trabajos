...
var app = {
    ...
    init: function() {
        ...
        if (!isMobile.any) {
            ...
            $(window).scroll(function() {
                ...
                $(".light").removeClass("lighting");
                $(".light").eq(indice[indice.length - 1]).addClass("lighting");
            });
        } else {
        ...
        $(".lnk-menu").click(function(event) {
            event.preventDefault();
            app.scrolling($.attr(this, "href"), 1e3);
    ...
    doTest: function() {
        console.log("PLAYING...!");
        bloques = $(".bloque");
        $(".start-discover").click(function(event) {
            bloques.fadeOut();
            bloques.eq(1).fadeIn();
        });
        ...
        $(".btn-next").click(function(event) {
            if (app.answers[question - 1] == undefined) {
                alert("No ha seleccionado la respuesta de la pregunta " + question);
                return;
            }
            question++;
            bloques.fadeOut();
            ...
            if (question > bloques.length) {
                $(".btn-prev, .btn-next").hide();
                $(".know-faction").show();
            }
        });
        $(".respuesta").click(function(event) {
            app.answers[question - 1] = event.currentTarget.dataset.rpta;
            $(this).parent().children(".respuesta").removeClass("selected");
            $(this).addClass("selected");
            console.log(app.answers);
        });
        $(".btn-know").click(function(event) {
            console.log(app.answers);
            if (app.answers[question - 1] == undefined) {
                alert("No ha seleccionado la respuesta de la última pregunta");
                return;
            }
            var cont = 0;
            var conteo = [];
            ...
            app.timer = setTimeout(function() {
                if ((filtro.length == 2 || filtro.length == 4) && mayor == null) {
                    console.log("Random");
                    key = filtro[parseInt(filtro.length * Math.random())];
                    console.log(key);
                    app.scrolling("#" + $(".section").eq(key).attr("id"), 2500);
                } else {
                    console.log("Pepepepepe");
                    app.scrolling("#" + $(".section").eq(mayor).attr("id"), 2500);
                }
                $(".overlayer").fadeOut();
    ...
    animations: function() {
        ...
        if ($(window).width() > 1024) {
            jarallax.addAnimation("#producto-exigencia", [ {
                progress: "0%",
                right: "120%",
                opacity: "0"
            }, {
            ...
            jarallax.addAnimation("#producto-supremacia", [ {
                progress: "0%",
                right: "130%",
                opacity: "0"
            }, {
            ...
            jarallax.addAnimation("#producto-resistencia", [ {
                progress: "0%",
                right: "140%",
                opacity: "0"
            }, {
            ...
            jarallax.addAnimation("#producto-ingenio", [ {
                progress: "0%",
                right: "150%",
                opacity: "0"
            }, {
            ...
            jarallax.addAnimation("#detalle-exigencia .image", [ {
                progress: "0%",
                left: "200%"
            }, {
                progress: "16.66%",
            ...
            jarallax.addAnimation("#detalle-supremacia .image", [ {
                progress: "0%",
                left: "200%"
            }, {
                progress: "32.66%",
            ...
            jarallax.addAnimation("#detalle-resistencia .image", [ {
                progress: "0%",
                left: "140%"
            }, {
                progress: "48.66%",
            ...
            jarallax.addAnimation("#detalle-ingenio .image", [ {
                progress: "0%",
                left: "150%"
            }, {
                progress: "64.66%",
