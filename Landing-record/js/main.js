...
var app = {
    init: function() {
        ...
        if (!isMobile.any) {
            _top_filtros = $("#menu-principal").offset().top;
            offset_filtros = _top_filtros - MARKETING_RIBBON.height();
            $(window).scroll(function() {
                var fromTop = $(this).scrollTop();
                if (fromTop > offset_filtros) {
                    $("#menu-principal").addClass("fixed").css({
                        top: MARKETING_RIBBON.height()
                    });
                } else {
                    $("#menu-principal").removeClass("fixed").removeAttr("style");
                }
            });
        } else {
            ...
            _top_filtros = $("#menu-principal-mobile").offset().top;
            _top_filtros2 = $("#menu-principal").offset().top;
            offset_filtros = _top_filtros - MARKETING_RIBBON.height();
            offset_filtros2 = _top_filtros2 - MARKETING_RIBBON.height();
            $(window).scroll(function() {
                var fromTop = $(this).scrollTop();
				if($(window).width() < 480){
					if (fromTop > offset_filtros) {
						$("#menu-principal-mobile").addClass("fixed").css({
							top: MARKETING_RIBBON.height()
						});
					} else {
						$("#menu-principal-mobile").removeClass("fixed").removeAttr("style");
					}
				} else {
					if (fromTop > offset_filtros2) {
						$("#menu-principal").addClass("fixed").css({
							top: MARKETING_RIBBON.height()
						});
					} else {
        ...
        $(".lnk-menuu").click(function(event) {
			...
			// $(window).scroll(function(event) {
				...
				// var indice = $(".section").map(function(index, elem) {
					...
					// }
				// });
				// $("#menu-principal ul a").removeClass("active");
				// $("#menu-principal ul a").eq(indice[Math.round(indice.length / 2) - 2]).addClass("active");
				// console.log(indice[Math.round(indice.length / 2) - 2]);
				// $("#menu-principal-mobile ul a").removeClass("active");
				// $("#menu-principal-mobile ul a").eq(indice[Math.round(indice.length / 2) - 1]).addClass("active");
			// });
        this.sliders();
    },
    scrolling: function(_hash, _speed) {
        ...
        if ($(_hash).length > 0) {
            $("html, body").animate({
                scrollTop: $(_hash).offset().top - aux
            }, _speed, function() {
                var item = $("#menu-principal-mobile ul a").map(function(index, elem) {
                    if ($(this).attr("href") == _hash) {
                        return index;
                    }
                });
                $("#menu-principal-mobile ul a").removeClass("active");
                $("#menu-principal-mobile ul a").eq(item[0]).addClass("active");
            });
        }
        return false;
    },
...
function onPlayerStateChange(e) {
    // e.data != YT.PlayerState.PLAYING || done || (setTimeout(stopVideo, 6e3), done = !0), 0 == e.data && $(".video").fadeIn()
}
...
$(document).ready(function(){
	$(window).scroll(function(event) {
		var fromTop = $(this).scrollTop();
		if($(window).width() > 480){
			_top_nav = $("#menu-principal").offset().top;
			offset_nav = _top_nav - MARKETING_RIBBON.height();
			if($(this).scrollTop()<($("#banner").offset().top - 85)){
				$('#landing-record #container #menu-principal #menu ul a.active').removeClass('active');
				$('#landing-record #container #menu-principal #menu ul a:eq(0)').addClass('active');
			}else if($(this).scrollTop()>($("#banner").offset().top - 85) && $(this).scrollTop()<($("#seccion-4").offset().top - 85)){
				$('#landing-record #container #menu-principal #menu ul a.active').removeClass('active');
				$('#landing-record #container #menu-principal #menu ul a:eq(1)').addClass('active');
			}else if($(this).scrollTop()>($("#seccion-4").offset().top - 85 )){
				$('#landing-record #container #menu-principal #menu ul a.active').removeClass('active');
				$('#landing-record #container #menu-principal #menu ul a:eq(2)').addClass('active');
			}
		}else{
			_top_nav = $("#menu-principal-mobile").offset().top;
			offset_nav = _top_nav - MARKETING_RIBBON.height();
			if($(this).scrollTop()<($("#banner").offset().top - 85)){
				$('#landing-record #container #menu-principal-mobile #menu-mobile a.active').removeClass('active');
				$('#landing-record #container #menu-principal-mobile #menu-mobile a:eq(1)').addClass('active');
			}else if($(this).scrollTop()>($("#banner").offset().top - 85) && $(this).scrollTop()<($("#seccion-4").offset().top - 85)){
				$('#landing-record #container #menu-principal-mobile #menu-mobile a.active').removeClass('active');
				$('#landing-record #container #menu-principal-mobile #menu-mobile a:eq(2)').addClass('active');
			}else if($(this).scrollTop()>($("#seccion-4").offset().top - 85 )){
				$('#landing-record #container #menu-principal-mobile #menu-mobile a.active').removeClass('active');
				$('#landing-record #container #menu-principal-mobile #menu-mobile a:eq(3)').addClass('active');
			}
		}
	});
});
